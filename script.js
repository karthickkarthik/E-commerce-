...
class ECommerceApp {
    ...
    setupEventListeners() {
        ...
        document.getElementById('wishlistBtn').addEventListener('click', () => this.showSection('user'));
        ...
        if (this.cart.length === 0) {
            container.innerHTML = `
                <div class="empty-cart">
                    ...
                    <button class="btn-primary" onclick="app.showSection('products')">Continue Shopping</button>
                </div>
            `;
        ...
        if (this.wishlist.length === 0) {
            container.innerHTML = `
                <div class="empty-state">
                    ...
                    <button class="btn-primary" onclick="app.showSection('products')">Browse Products</button>
                </div>
            `;
            return;
        }
        ...
        if (orders.length === 0) {
            container.innerHTML = `
                <div class="empty-state">
                    ...
                    <button class="btn-primary" onclick="app.showSection('products')">Start Shopping</button>
                </div>
            `;
            return;
        }
